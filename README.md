# Live-Subtitle-V2
ANDROID APP that will recognize VLC LIVE AUDIO/VIDEO STREAMING then TRANSLATE (using unofficial online GOOGLE TRANSLATE API) and display it as LIVE CAPTIONS / LIVE SUBTITLES
