# Live-Subtitle-V2
ANDROID APP that will recognize (using free Android Developer Speech Recognition API) OPERA BROWSER LIVE AUDIO/VIDEO STREAMING then TRANSLATE (using unofficial online GOOGLE TRANSLATE API) and display it as LIVE CAPTIONS / LIVE SUBTITLES
...
CONS:
It's very laggy and for online streaming currently I can only test it in OPERA WEB BROWSER (VLC seems can no longer play youtube streams)
